...
INSERT INTO users VALUES (DEFAULT, 'Склад "ЛДСП"', 'sup.makulin@mail.ru');
INSERT INTO users VALUES (DEFAULT, 'Менеджер', 'sadasdad@mail.ru');
INSERT INTO users VALUES (DEFAULT, 'Оператор ЧПУФРС', '123gfg@mail.ru');
INSERT INTO users VALUES (DEFAULT, 'Кладовщик', 'solovg@mail.ru');
